...
final class ServiceMethod<R, T> {
  ...
  static final class Builder<T, R> {
    ...
    Builder(Renovate renovate, Method method) {
    ...
    public ServiceMethod build() {
      ...
      for (int p = 0; p < parameterCount; p++) {
        ...
        if (parameterAnnotations == null) {
          throw parameterError(p, "No Renovate annotation found.");
        }
    ...
    private ParameterHandler<?> parseParameterAnnotation(
      ...
      if (annotation instanceof Url) {
        ...
        if (partName.isEmpty()) {
          ...
          if (Iterable.class.isAssignableFrom(rawParameterType)) {
            ...
            Converter<?, RequestBody> converter =
                renovate.requestBodyConverter(iterableType, annotations, methodAnnotations);
            ...
            Converter<?, RequestBody> converter =
                renovate.requestBodyConverter(arrayComponentType, annotations, methodAnnotations);
            ...
            Converter<?, RequestBody> converter =
                renovate.requestBodyConverter(type, annotations, methodAnnotations);
        ...
        Converter<?, RequestBody> valueConverter =
            renovate.requestBodyConverter(valueType, annotations, methodAnnotations);
        ...
        Converter<?, RequestBody> converter;
        try {
          converter = renovate.requestBodyConverter(type, annotations, methodAnnotations);
